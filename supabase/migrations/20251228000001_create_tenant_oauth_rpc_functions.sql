-- ============================================================================
-- RPC FUNCTIONS FOR TENANT OAUTH CREDENTIALS
-- ============================================================================
-- These functions provide secure access to tenant OAuth credentials stored
-- in Supabase Secrets Management. They handle metadata retrieval and
...
-- ============================================================================
-- Returns the secret names and metadata for tenant credentials
-- The actual secret values must be retrieved via Edge Functions
-- ============================================================================
...
-- ============================================================================
-- Creates or updates tenant OAuth credential metadata
-- The actual secrets should be stored in Supabase Secrets before calling this
-- ============================================================================
...
-- ============================================================================
-- Soft deletes tenant OAuth credentials by setting is_active = FALSE
-- The actual secrets in Supabase Secrets should be deleted separately
-- ============================================================================
...
-- ============================================================================
-- Returns credential metadata with priority:
-- 1. Tenant-specific credentials from Supabase Secrets
-- 2. Fallback to platform defaults (indicated by returning NULL secret names)
-- ============================================================================
...
-- ============================================================================
-- Returns all active OAuth credentials for a tenant
-- ============================================================================
